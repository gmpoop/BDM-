...
<main class="pt-20 bg-purple-50 w-auto ">
    ...
    <footer class="bg-white py-20 px-20">
        <div class="max-w-7xl mx-auto grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-8">
          ...
          <div>
            <h3 class="text-lg font-bold text-gray-900">Soluciones</h3>
            <ul class="mt-4 space-y-2">
              <li><a href="#" class="text-gray-600 hover:text-[#4821ea]">Capacitación (LMS)</a></li>
              <li><a href="#" class="text-gray-600 hover:text-[#4821ea]">Experiencia (LXP)</a></li>
              <li><a href="#" class="text-gray-600 hover:text-[#4821ea]">E-learning</a></li>
              <li><a href="#" class="text-gray-600 hover:text-[#4821ea]">Reconocimiento</a></li>
              <li><a href="#" class="text-gray-600 hover:text-[#4821ea]">Feedback</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul class="mt-4 space-y-2">
              <li><a href="#" class="text-gray-600 hover:text-[#4821ea]">Blog</a></li>
              <li><a href="#" class="text-gray-600 hover:text-[#4821ea]">Podcast</a></li>
              ...
              <li><a href="#" class="text-gray-600 hover:text-[#4821ea]">Youtube</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul class="mt-4 space-y-2">
              ...
              <li><a href="#" class="text-gray-600 hover:text-[#4821ea]">Política de cookies</a></li>
              <li><a href="#" class="text-gray-600 hover:text-[#4821ea]">Solicitud ARCO</a></li>
